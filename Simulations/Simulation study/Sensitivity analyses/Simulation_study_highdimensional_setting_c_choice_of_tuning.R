...
Iter = 10000 # 5000
nstop = p / 2
const = "AIC" # const = 1 # gamma (Penalty for shrinkage in EBIC)
...
save(results, file="Sim_Toeplitz08_p1000_n1000_nSim500_Iter10000_fixedS0_100_autostop_choice_of_tuning.RData")
