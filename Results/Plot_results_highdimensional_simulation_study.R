...
color_boxes = c(pal_col[2:4], rep("gray",7))
...
par(mfrow=c(2,2))
boxplot(take_element(results,1,1,nSim), take_element(results,2,1,nSim), take_element(results,3,1,nSim), take_element(results,10,1,nSim), 
        take_element(results,4,1,nSim), take_element(results,5,1,nSim), take_element(results,6,1,nSim),
...
boxplot(take_element(results,1,2,nSim), take_element(results,2,2,nSim), take_element(results,3,2,nSim), take_element(results,10,2,nSim), 
        take_element(results,4,2,nSim), take_element(results,5,2,nSim), take_element(results,6,2,nSim),
...
boxplot(take_element(results,1,3,nSim), take_element(results,2,3,nSim), take_element(results,3,3,nSim), take_element(results,10,3,nSim), 
        take_element(results,4,3,nSim), take_element(results,5,3,nSim), take_element(results,6,3,nSim),
...
boxplot(take_element(results,1,4,nSim), take_element(results,2,4,nSim), take_element(results,3,4,nSim), take_element(results,10,4,nSim), 
        take_element(results,4,4,nSim), take_element(results,5,4,nSim), take_element(results,6,4,nSim),
...
boxplot(take_element(results,1,4,nSim), take_element(results,2,4,nSim), take_element(results,3,4,nSim), take_element(results,10,4,nSim), 
        ...
        col = color_boxes,
        outcol=color_boxes,outpch = 19)
text(1:length(method_names), par("usr")[3] - 0.07, labels = method_names, srt = angle, adj = 1, xpd = TRUE, cex=cex.names)
...
boxplot(take_element3(results_criterion,1,1,1,nSim), take_element3(results_criterion,2,1,1,nSim), 
        ...
        take_element(results,3,1,nSim), take_element(results,10,1,nSim), 
        take_element(results,4,1,nSim), take_element(results,5,1,nSim), take_element(results,6,1,nSim),
        take_element(results,7,1,nSim), take_element(results,8,1,nSim), 
        xaxt="n", main ="False Positives", 
        col = color_boxes,
...
boxplot(take_element3(results_criterion,1,1,2,nSim), take_element3(results_criterion,2,1,2,nSim), 
        ...
        take_element(results,3,2,nSim), take_element(results,10,2,nSim), 
        take_element(results,4,2,nSim), take_element(results,5,2,nSim), take_element(results,6,2,nSim),
        take_element(results,7,2,nSim), take_element(results,8,2,nSim), 
        xaxt="n", main ="False Negatives", 
        col = color_boxes,
...
boxplot(take_element3(results_criterion,1,1,3,nSim), take_element3(results_criterion,2,1,3,nSim), 
        ...
        take_element(results,3,3,nSim), take_element(results,10,3,nSim), 
        take_element(results,4,3,nSim), take_element(results,5,3,nSim), take_element(results,6,3,nSim),
        take_element(results,7,3,nSim), take_element(results,8,3,nSim), 
        xaxt="n", main ="Estimation Error (MSE)", 
        col = color_boxes,
...
boxplot(take_element3(results_criterion,1,1,4,nSim), take_element3(results_criterion,2,1,4,nSim), 
        ...
        take_element(results,3,4,nSim), take_element(results,10,4,nSim),
        take_element(results,4,4,nSim), take_element(results,5,4,nSim), take_element(results,6,4,nSim),
        take_element(results,7,4,nSim), take_element(results,8,4,nSim), 
        xaxt="n", main ="Prediction Error (RMSE)", 
        col = color_boxes,
